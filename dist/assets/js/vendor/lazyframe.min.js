...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).lazyframe = e();
}(void 0, function () {
  "use strict";
  ...
  return function () {
    var e,
      ...
      onAppend: function onAppend(t) {},
      onThumbnailLoad: function onThumbnailLoad(t) {}
    },
        o = {
      regex: {
      ...
      condition: {
        ...
        youtube_nocookie: function youtube_nocookie(t) {
          return !(!t || 11 != t[1].length) && t[1];
        },
      ...
      src: {
        youtube: function youtube(t) {
          return "https://www.youtube.com/embed/".concat(t.id, "/?autoplay=").concat(t.autoplay ? "1" : "0");
        },
        youtube_nocookie: function youtube_nocookie(t) {
          return "https://www.youtube-nocookie.com/embed/".concat(t.id, "/?autoplay=").concat(t.autoplay ? "1" : "0");
        },
        vimeo: function vimeo(t) {
          return "https://player.vimeo.com/video/".concat(t.id, "/?autoplay=").concat(t.autoplay ? "1" : "0");
        }
      },
      endpoint: function endpoint(t) {
      ...
      response: {
        ...
        thumbnail: function thumbnail(t) {
    ...
    function r(n) {
      var i = Array.prototype.slice.apply(n.attributes).filter(function (t) {
        return "" !== t.value;
      }).reduce(function (t, e) {
      ...
      if (a.vendor) {
        var r = a.src.match(o.regex[a.vendor]);
        a.id = o.condition[a.vendor](r);
      }
    ...
    return function (n) {
      if (e = t({}, i, arguments.length <= 1 ? void 0 : arguments[1]), "string" == typeof n) for (var o = document.querySelectorAll(n), r = 0; r < o.length; r++) {
        a(o[r]);
      } else if (void 0 === n.length) a(n);else if (n.length > 1) for (var l = 0; l < n.length; l++) {
        a(n[l]);
      } else a(n[0]);
      e.lazyload && u();
    };
