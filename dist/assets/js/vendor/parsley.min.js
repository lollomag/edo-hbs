...
!function (t, e) {
  ...
  r.prototype = {
    ...
    off: function off(t, e) {
      ...
      if (i) if (e) for (var r = i.length; r--;) {
        i[r] === e && i.splice(r, 1);
  ...
  function m(s, a) {
    return function (t) {
      for (var e = arguments.length, i = new Array(1 < e ? e - 1 : 0), r = 1; r < e; r++) {
        i[r - 1] = arguments[r];
      }
  ...
  a.prototype = {
    init: function init(t, e) {
      for (var i in this.catalog = e, this.validators = l({}, this.validators), t) {
    ...
    _setValidator: function _setValidator(t, e, i) {
      for (var r in "object" !== n(e) && (e = {
        fn: e,
        priority: i
      }), e.validate || (e = new c(e)), (this.validators[t] = e).messages || {}) {
  ...
  w.prototype = {
    ...
    _bindConstraints: function _bindConstraints() {
      ...
      for (var r in this.constraints = t, this.constraintsByName = e, this.options) {
